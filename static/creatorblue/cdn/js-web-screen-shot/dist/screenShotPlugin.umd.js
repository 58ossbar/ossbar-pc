...
var InitData_toolController = null; // 获取文本输入区域dom
...
var InitData_InitData = /*#__PURE__*/function () {
  ...
  _createClass(InitData, [{
    ...
    value: function destroyDOM() {
      if (InitData_screenShortController == null || InitData_toolController == null || optionIcoController == null || optionController == null || InitData_textInputController == null) return; // 销毁dom
...
function drawCutOutBox(mouseX, mouseY, width, height, context, borderSize, controller, imageController) {
  ...
  // 自己修改 ---解决 截图模糊问题
  context.drawImage(imageController, 0, 0, imgWidth, imgHeight, 0, 0, window.innerWidth, window.innerHeight);
...
//   context.drawImage(imageController, 0, 0, controller === null || controller === void 0 ? void 0 : controller.width, controller === null || controller === void 0 ? void 0 : controller.height); // 绘制结束
   // 自己修改 -----解决 截图模糊问题
   context.drawImage(imageController, 0, 0, controller === null || controller === void 0 ? void 0 : controller.width, controller === null || controller === void 0 ? void 0 : controller.height, 0, 0, window.innerWidth, window.innerHeight); // 绘制结束
  ...
  function ScreenShort(options) {
    ...
    _defineProperty(this, "mouseUpEvent", function () {
      ...
      if (cutBoxPosition.width === 0 && cutBoxPosition.height === 0 && cutBoxPosition.startX === 0 && cutBoxPosition.startY === 0 && !_this.dragFlag && _this.clickCutFullScreen) {
        ...
        _this.tempGraphPosition = drawCutOutBox(0, 0, _this.screenShortController.width - borderSize / 2, _this.screenShortController.height - borderSize / 2, _this.screenShortCanvas, borderSize, _this.screenShortController, _this.screenShortImageController);
      }
      ...
      if (_this.screenShortController != null) {
        ...
        if (_this.toolController != null) {
          // 计算截图工具栏位置
          var toolLocation = calculateToolLocation(_this.drawGraphPosition, _this.toolController.offsetWidth); // 当前截取的是全屏，则修改工具栏的位置到截图容器最底部，防止超出
          ...
          _this.data.setToolInfo(toolLocation.mouseX + _this.position.left, toolLocation.mouseY + _this.position.top); // 状态重置
    ...
    var _plugInParameters = new PlugInParameters_PlugInParameters(); // webrtc启用状态


    if (options && Object.prototype.hasOwnProperty.call(options, "enableWebRtc")) {
      _plugInParameters.setWebRtcStatus(options.enableWebRtc);
    } // 单击截取全屏启用状态
    ...
    if (options && Object.prototype.hasOwnProperty.call(options, "canvasWidth") && Object.prototype.hasOwnProperty.call(options, "canvasHeight")) {
      _plugInParameters.setCanvasSize(options.canvasWidth, options.canvasHeight);
    } // 设置截图容器的位置信息
    ...
    screenShotContainer.style.zIndex = "".concat(options === null || options === void 0 ? void 0 : options.level);
    this.toolController.style.zIndex = "".concat((options === null || options === void 0 ? void 0 : options.level) + 1); // 创建键盘事件监听

    new KeyboardEventHandle_KeyboardEventHandle(this.screenShortController, this.toolController);
  } // 获取截图区域canvas容器
